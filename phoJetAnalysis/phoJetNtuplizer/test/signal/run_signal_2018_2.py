...
'file:/hdfs/store/user/ms/monoHiggs_2018_signalSample_MINIAOD/2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_MH3_200_MH4_100_MH2_200_MHC_200-miniAOD_submit/miniAOD_submit-AOD_submit-REDIGI_submit_2018-2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_MH3_200_MH4_100_MH2_200_MHC_200-0051.root',

    )
)

process.TFileService = cms.Service("TFileService", 
    fileName = cms.string('Ntuple_signal_50to150.root')
    )
