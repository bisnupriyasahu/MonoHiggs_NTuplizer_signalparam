...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        #'file:/hdfs/store/user/ms/monoHiggs_2018_signalSample_MINIAOD/2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_MH3_200_MH4_100_MH2_200_MHC_200-miniAOD_submit/miniAOD_submit-AOD_submit-REDIGI_submit_2018-2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_MH3_200_MH4_100_MH2_200_MHC_200-0000.root',
        'file:/afs/hep.wisc.edu/home/bsahu/ZPB_sample/0A041F28-3303-EB11-BFA0-98039B3B0036.root',


    )
)
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string('Output_AN_Ntuple_signal_lhtnotvalid_signalparam_clear.root')
    )
