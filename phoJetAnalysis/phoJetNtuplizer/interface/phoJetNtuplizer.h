...
class phoJetNtuplizer : public edm::one::EDAnalyzer<edm::one::SharedResources,edm::one::WatchLuminosityBlocks>{
  public:
  ...
  private:
    ...
    void reset();
    virtual void getSVJComment(const string& gen);
    ...
    //void branchsignalParameter    (TTree*);
